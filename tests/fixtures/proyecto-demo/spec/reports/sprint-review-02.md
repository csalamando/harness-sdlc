...
Generado: 2026-08-12 | Periodo (recibos): 2026-08-01 → 2026-08-12

<!-- KPIs para tendencia (no borrar, los lee sprint_review.py) -->
<!-- Artefactos aprobados: 3 -->
...
- Artefactos aprobados (recibos vigentes): **3**
- Gates al primer intento: **75%**
...
| backend-dev | 4 | 2 | 75% | 6,200 est. |
| frontend-dev | 3 | 2 | 100% | 4,900 est. |
